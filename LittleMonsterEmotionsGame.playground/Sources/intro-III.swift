...
public class IntroIIViewController: UIViewController {
    ...
    public override func loadView(){
        ...
        let hi = UILabel()
        hi.frame = CGRect(x: 90, y: 90, width: 600, height: 200)
        //hi.backgroundColor = #colorLiteral(red: 0.1411764771, green: 0.3960784376, blue: 0.5647059083, alpha: 1)
        hi.text = "Music is closely related to our emotions. They can make us happy, excited, relaxed, calm and even sad..."
    ...
    @objc func buttonPress() {
        var gameView = IntroIIIViewController()
        print(gameView)
